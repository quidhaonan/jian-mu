...
public class CaptchaConfig {
    ...
    public DefaultKaptcha getKaptchaBeanMath() {
        ...
        // 验证码文本生成器
        properties.setProperty(KAPTCHA_TEXTPRODUCER_IMPL, "com.lmyxlf.jian_mu.admin.config.KaptchaTextCreator");
        // 验证码文本字符间距，默认为 2
