...
import com.lmyxlf.jian_mu.global.annotation.JsonParamAnnotation;
...
public class JsonParamModelAttributeMethodProcessor implements HandlerMethodArgumentResolver {
    ...
    public boolean supportsParameter(MethodParameter parameter) {
        ...
        return parameter.hasParameterAnnotation(JsonParamAnnotation.class);
    }
    ...
    public Object resolveArgument(MethodParameter parameter, ModelAndViewContainer mavContainer, NativeWebRequest webRequest, WebDataBinderFactory binderFactory) throws Exception {
        ...
        // 2、获取参数名
        JsonParamAnnotation jsonParamAnnotation = parameter.getParameterAnnotation(JsonParamAnnotation.class);
        assert jsonParamAnnotation != null;
        String paramName = jsonParamAnnotation.value();
        // 3、注解没有给的参数名字，默认取参数名
